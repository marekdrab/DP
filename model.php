...
<script>
    ...
    $(document).ready(function () {
        ...
        const mainJS = () => {
            ...
            //         'target': {
            //             'value': null,
            //             'provider': '{"type":"MP","id":"const.k","parent":"model-id"}', //id: e
            //             'array': !1,
            //             'indexes': null,
            //             'function': null,
            //             'typeof': 'number'
            ...
            const functions = {
                ...
                'continuous': {
                    ...
                    'setValue': function setValue(reference, value) {
                        ...
                        //     case 'dataset-0':
                        //         value = localStorage.getItem('input-0')                                break;
                        //     case 'dataset-1':
                        //         value = localStorage.getItem('input-1')                                break;
                        //     case 'dataset-2':
                        //         value = localStorage.getItem('input-2')                                break;
                        //     case 'dataset-3':
            ...
            function updateSimulationInputs() {
                ...
                if (models['model-id'] && models['model-id'].setValue) {
                    models['model-id'].setValue('16777348', newValue); // Ensure `reference` is correctly defined
                }
            }
            ...
            function init() {
                ...
                Promise.all([
                    ...
                    Promise.all([initWidgets()]).then(() => {
                        ...
                        if (stopModel) {
                            stopModel.addEventListener('click', function() {
                                if (models['model-id'] && models['model-id'].pause) {
